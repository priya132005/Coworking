                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr-2 bg-gray-100 sm:rounded-lg">
                            <h1 className="text-3xl font-extrabold tracking-tight text-gray-800 sm:text-4xl">
                                Get in touch for best working environment: 
                            </h1>
                        ...
                        <form className="flex flex-col justify-center p-6">
                            ...
                            <button
                                type="submit"
                                className="px-6 py-3 mt-3 font-bold text-white transition duration-300 ease-in-out bg-pink-700 rounded-lg md:w-32 hover:bg-blue-dark hover:bg-orange-600"
                            >
                                Submit
                            </button>
                        </form>
